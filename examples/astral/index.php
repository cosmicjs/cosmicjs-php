...
<html>
	...
	<body class="landing" style="background-size: 100%; background-repeat: no-repeat; background-image: url('<?php echo $config->file_url . "/" . $cosmic['hero-unit']->metafield['hero']; ?>');">
				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							...
							<ul class="actions">
								<li><a href="#" class="button special"><?php echo $cosmic['hero-unit']->metafield['button-text']; ?></a></li>
							</ul>
						</div>
					...
					<section id="cta" class="wrapper style4">
						<div class="inner">
							...
							<ul class="actions vertical">
								<li><a href="#" class="button fit special"><?php echo $cosmic['section-4']->metafield['primary-btn']; ?></a></li>
								<li><a href="#" class="button fit"><?php echo $cosmic['section-4']->metafield['secondary-btn']; ?></a></li>
							</ul>
						</div>
					</section>
				...
				<!-- Footer -->
					<footer id="footer">
						<ul class="icons">
							...
							<li><a href="<?php echo $cosmic['social']->metafield['facebook']; ?>" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
							<li><a href="<?php echo $cosmic['social']->metafield['instagram']; ?>" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
							<li><a href="<?php echo $cosmic['social']->metafield['dribble']; ?>" class="icon fa-dribbble"><span class="label">Dribbble</span></a></li>
							<li><a href="<?php echo $cosmic['social']->metafield['email']; ?>" class="icon fa-envelope-o"><span class="label">Email</span></a></li>
						</ul>
						<ul class="copyright">
							<li>&copy; <?php echo $cosmic['header-footer']->metafield['site-title']; ?></li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
						</ul>
					</footer>
